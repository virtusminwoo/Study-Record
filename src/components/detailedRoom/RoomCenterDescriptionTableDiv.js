            ...
            <div className="RoomCenterDescriptionTableDiv">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr><td>해당 층 / 건물 층</td><th>{props.room.layers}</th><td className="RoomCenterDescriptionTableRight">전용 / 공급면적</td><th>{props.room.area}</th></tr>
                            <tr><td>관리비</td><th>{props.room.administrativeFee}</th><td className="RoomCenterDescriptionTableRight">관리비포함항목</td><th>{props.room.administrativeType}</th></tr>
