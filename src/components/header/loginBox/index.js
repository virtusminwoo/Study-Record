...
const mapDispatchToProps = (dispatch) => ({
    HandleSubmitIfEmail: (e) => dispatch(actions.HandleSubmitIfEmail(e)),
    HandleSubmitIfPassword: (e) => dispatch(actions.HandleSubmitIfPassword(e)),
    HandleSubmitElse: (e) => dispatch(actions.HandleSubmitElse(e)),
    HandleSubmitSet: (e) => dispatch(actions.HandleSubmitSet(e)),
